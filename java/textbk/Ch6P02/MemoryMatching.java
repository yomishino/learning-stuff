...
public class MemoryMatching {
    ...
    private static char[] VALUES = {'1', '2', '3', '4', '5', 
                                    '6', '7', '8'};
    ...
    /**
     * (Re-)Starts a game with default settings.
     */
    public void newGame() {
    ...
    /**
     * (Re-)Starts a game with the given cards and the
    ...
    /**
     * (Re-)Starts a game with the given cards and 
     * table settings.
     * @param cards An array of <code>Card</code>s,
     * not necessarily in order but should be in pairs.
    ...
    /**
     * (Re-)Starts a game with the given values to generate
    ...
    /**
     * (Re-)Starts a game with the given table settings;
    ...
    /**
     * Sets the game with the given table.
     * The table should be an <i>h</i> * <i>w</i> array of 
     * <code>Card</code> object where <i>h</i> is the height of 
     * 1the table and <i>w</i> the width.
     ...
     * <p>
     * The given <code>Card</code> objects will be directly
     * used for making the table. Deep copies of cards should
     * be made before calling this method if necessary.
    ...
    private void matchingAttempt(int[] pos1, int[] pos2) 
        ...
        if (card1 != card2 && match(card1, card2))
            ...
            try {
                Thread.sleep(1000);     // Pause 1s for player
            } catch (Exception e) {
